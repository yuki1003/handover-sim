...
_C.ENV.OFFSCREEN_RENDERER_CAMERA_POSITION = (0.61, -0.20, 2.25)#(1.2127, -0.5531, 1.4090)

_C.ENV.OFFSCREEN_RENDERER_CAMERA_TARGET = (0.60, -0.20, 1.25)#(0.48, 0.0, 1.19)
...
_C.BENCHMARK.SETUP = "s1"#"s0"

_C.BENCHMARK.SPLIT = "val"#"test"
